"""Vistas HTML utilizadas para exponer la interfaz web de Verifactura."""
...
async def home(request: Request) -> HTMLResponse:
    """Renderiza la página principal con valores sugeridos para los modelos LLM."""
    ...
    # Se organizan los valores por defecto que consumirá el frontend
    llm_defaults = {
        "api": {
            "model": api_model,
            "options": api_options,
